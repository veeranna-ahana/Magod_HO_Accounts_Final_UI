...
export default function Draft_List() {
  ...
  const prvListSubmit = async () => {
    try {
      const response = await axios.get(baseURL + "/prvListdata/getDraftList"); // Replace this URL with your API endpoint
  ...
  return (
    <>
      <div className="row">
        <h4 className="title">HO Draft List</h4>
      </div>

      <div className="row">
        <div className="col-md-10">
          <label className="form-label">
            Magod Laser :HO Receipt Voucher List
          </label>
        </div>
